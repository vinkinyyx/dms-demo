...
> **版本**: v1.4
> **创建时间**: 2026-08-11
> **最近更新**: 2026-08-30（v4.4.6 移动端“很慢/刷不出来”修复：前端令牌刷新误打 /auth/refresh 应为 /api/auth/refresh（404 致 token 过期后整页挂起）、登录过期按设备跳转、op_log varchar 超长 @PrePersist 截断；新增踩坑点 L73/L74；无 Flyway 变更）
