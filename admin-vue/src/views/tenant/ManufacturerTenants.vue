...
const form = reactive({ code: '', name: '', contactName: '', contactPhone: '', adminUsername: '', adminPassword: '', adminName: '' })
...
function openCreate() {
  Object.assign(form, { code: '', name: '', contactName: '', contactPhone: '', adminUsername: '', adminPassword: '', adminName: '' })
  dialog.value = true
}
async function save() {
  saving.value = true
