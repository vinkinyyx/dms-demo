...
function openCreate() { Object.assign(form, { code: '', name: '', tenantType: tenantType.value, dataScope: 'ALL_TENANT', description: '' }); createVisible.value = true }
async function saveCreate() { await createRoleTemplate(form); ElMessage.success('已创建'); createVisible.value = false; load() }
