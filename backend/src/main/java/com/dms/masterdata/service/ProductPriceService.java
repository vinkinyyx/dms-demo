...
public class ProductPriceService {
    ...
    @Transactional
    public ApiResponse<Map<String, Object>> activate(Long id) { toggleStatus(id, "active"); return ApiResponse.ok(Map.of("id", id)); }
    @Transactional
    public ApiResponse<Map<String, Object>> deactivate(Long id) { toggleStatus(id, "inactive"); return ApiResponse.ok(Map.of("id", id)); }
