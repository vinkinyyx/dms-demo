...
@Data
public class DealerTenantCreateRequest {
    @NotNull(message = "manufacturer tenant required") private UUID manufacturerTenantId;
    @NotNull(message = "dealer required") private Long dealerId;
