...
public class OrderApprovalExecutionService {
     ...
     */
    @Transactional
    public ApiResponse<Map<String, Object>> approvePO(Long id) {
        UUID tid = TenantContext.getTenantId();
        var q = em.createNativeQuery(
     ...
     */
    @Transactional
    public ApiResponse<Map<String, Object>> executeSalesOut(Long id, Map<String, Object> body) {
        UUID tid = TenantContext.getTenantId();
        var q = em.createNativeQuery(
        ...
        if (body != null && body.get("lines") instanceof List) {
            for (Object o : (List<?>) body.get("lines")) {
                if (o instanceof Map) {
                    Map<?, ?> m = (Map<?, ?>) o;
                    Long lid = SqlValueSupport.toLong(m.get("salesOutLineId"));
    ...
    @Transactional
    public ApiResponse<Map<String, Object>> cancelSalesOut(Long id) {
        UUID tid = TenantContext.getTenantId();
     ...
     */
    @Transactional
    public ApiResponse<Map<String, Object>> executeReceipt(Long id, Map<String, Object> body) {
        UUID tid = TenantContext.getTenantId();
        var q = em.createNativeQuery(
        ...
        if (body != null && body.get("lines") instanceof List) {
            for (Object o : (List<?>) body.get("lines")) {
                if (o instanceof Map) {
                    Map<?, ?> m = (Map<?, ?>) o;
                    Long lid = SqlValueSupport.toLong(m.get("receiptLineId"));
                    if (lid == null) continue;
                    Map<String, Object> vv = new HashMap<>();
                    Object b = m.get("batchNo"); if (b != null) vv.put("batch", String.valueOf(b));
                    Object s = m.get("serialNo"); if (s != null) vv.put("serial", String.valueOf(s));
    ...
    @Transactional
    public ApiResponse<Map<String, Object>> cancelReceipt(Long id) {
        UUID tid = TenantContext.getTenantId();
        int updated = em.createNativeQuery(
