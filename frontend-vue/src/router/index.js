...
const routes = [
  ...
  { path: '/login', name: 'Login', component: () => import('@/views/Login.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'order-create/sales/:id?', name: 'SalesOrderCreate', component: () => import('@/views/OrderCreate.vue'), meta: { title: '销售订单编辑' }, props: true },
      ...
      { path: 'sales-return-edit', name: 'SalesReturnCreate', component: () => import('@/views/SalesReturnEdit.vue'), meta: { title: '新建销退' } },
      { path: 'sales-return-edit/:id', name: 'SalesReturnEdit', component: () => import('@/views/SalesReturnEdit.vue'), meta: { title: '销退订单' }, props: true },
