...
const routes = [
  ...
  { path: '/login', name: 'Login', component: () => import('@/views/Login.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'authorizations', name: 'AuthorizationList', component: () => import('@/views/authorization/AuthorizationList.vue'), meta: { title: '授权管理' } },
      { path: 'authorizations/new', name: 'AuthorizationCreate', component: () => import('@/views/authorization/AuthorizationEdit.vue'), meta: { noCache: true, title: '新增授权' } },
      { path: 'authorizations/:id', name: 'AuthorizationDetail', component: () => import('@/views/authorization/AuthorizationDetail.vue'), meta: { title: '授权详情' } },
