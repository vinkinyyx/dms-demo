...
E2E_BASE=http://dms-dev.mysolmed.com npm run test:smoke  # domain (2026-08-28+); IP http://43.128.145.141 also works; API/health use root; UI pages use /dms, /dms/admin, /dms/mobile
