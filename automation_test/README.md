...
| 环境   | 前端入口 | API 地址 |
| ------ | --------------------------- | ---------------------------- |
| `test` | http://43.128.145.141/ | http://43.128.145.141/（同源 `/api`、`/auth`、`/actuator`） |
| `prod` | http://8.133.193.238/dms/（移动 /dms/mobile/login，后台 /dms/admin/） | http://8.133.193.238/（同源 `/api`、`/auth`、`/actuator`） |

> v3.12.4 起两套环境均统一走 80 端口；生产 DMS 挂在 `/dms/` 子路径，历史 8080/8081/8082/8083 端口拓扑已废弃。
...
- [ ] 测试环境 http://43.128.145.141/actuator/health 返回 `{"status":"UP"}`（生产为 http://8.133.193.238/actuator/health）
